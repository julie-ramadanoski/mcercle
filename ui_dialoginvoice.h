...
public:
    ...
    QLabel *label_typePayment;
    QComboBox *comboBox_TYPE_PAYMENT;
    QHBoxLayout *horizontalLayout_items;
    ...
    QPushButton *pushButton_partInvoice;
    QPushButton *pushButton_creditInvoice;
    ...
    void setupUi(QDialog *DialogInvoice)
    {
        ...
        gridLayout->addWidget(label_payment, 2, 2, 1, 1);

        dateEdit_payment = new QDateEdit(DialogInvoice);
        dateEdit_payment->setObjectName(QString::fromUtf8("dateEdit_payment"));
        dateEdit_payment->setCalendarPopup(true);

        gridLayout->addWidget(dateEdit_payment, 2, 3, 1, 1);
        ...
        label_typePayment = new QLabel(DialogInvoice);
        label_typePayment->setObjectName(QString::fromUtf8("label_typePayment"));

        gridLayout->addWidget(label_typePayment, 1, 4, 1, 1);
        ...
        horizontalLayout_items = new QHBoxLayout();
        horizontalLayout_items->setObjectName(QString::fromUtf8("horizontalLayout_items"));
        ...
        horizontalLayout_items->addWidget(groupBox_select);
        ...
        verticalLayout_center->addItem(verticalSpacer_2);

        toolButton_hide = new QToolButton(DialogInvoice);
        toolButton_hide->setObjectName(QString::fromUtf8("toolButton_hide"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/app/show"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_hide->setIcon(icon3);
        toolButton_hide->setIconSize(QSize(24, 24));

        verticalLayout_center->addWidget(toolButton_hide);

        toolButton_add = new QToolButton(DialogInvoice);
        toolButton_add->setObjectName(QString::fromUtf8("toolButton_add"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/app/next"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_add->setIcon(icon4);
        toolButton_add->setIconSize(QSize(24, 24));

        verticalLayout_center->addWidget(toolButton_add);

        verticalSpacer = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout_center->addItem(verticalSpacer);


        horizontalLayout_items->addLayout(verticalLayout_center);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/app/insert"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_addFreeline->setIcon(icon5);
        toolButton_addFreeline->setIconSize(QSize(24, 24));
        toolButton_addFreeline->setPopupMode(QToolButton::DelayedPopup);
        toolButton_addFreeline->setAutoRaise(false);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/app/remove"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_rm->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/app/up"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_up->setIcon(icon7);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/app/dn"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_dn->setIcon(icon8);
        ...
        horizontalLayout_items->addWidget(groupBox_invoice);

        horizontalLayout_items->setStretch(0, 35);
        horizontalLayout_items->setStretch(2, 65);

        verticalLayout->addLayout(horizontalLayout_items);
        ...
        horizontalLayout_2->addWidget(label_partpayment);
        ...
        pushButton_partInvoice = new QPushButton(DialogInvoice);
        pushButton_partInvoice->setObjectName(QString::fromUtf8("pushButton_partInvoice"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/app/addFile"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_partInvoice->setIcon(icon9);

        horizontalLayout_button->addWidget(pushButton_partInvoice);

        pushButton_creditInvoice = new QPushButton(DialogInvoice);
        pushButton_creditInvoice->setObjectName(QString::fromUtf8("pushButton_creditInvoice"));
        pushButton_creditInvoice->setEnabled(true);
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/app/undo"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_creditInvoice->setIcon(icon10);

        horizontalLayout_button->addWidget(pushButton_creditInvoice);
        ...
        pushButton_print = new QPushButton(DialogInvoice);
        pushButton_print->setObjectName(QString::fromUtf8("pushButton_print"));
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/app/print"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_print->setIcon(icon11);

        horizontalLayout_button->addWidget(pushButton_print);
        ...
        pushButton_close = new QPushButton(DialogInvoice);
        pushButton_close->setObjectName(QString::fromUtf8("pushButton_close"));
        pushButton_close->setAutoDefault(false);

        horizontalLayout_button->addWidget(pushButton_close);
        ...
        QWidget::setTabOrder(comboBox_TYPE_PAYMENT, toolButton_add);
        QWidget::setTabOrder(toolButton_add, pushButton_ok);
        QWidget::setTabOrder(pushButton_ok, pushButton_close);
    ...
    void retranslateUi(QDialog *DialogInvoice)
    {
        ...
        label_datevalid->setText(QApplication::translate("DialogInvoice", "Validit\303\251 :", 0, QApplication::UnicodeUTF8));
        label_payment->setText(QApplication::translate("DialogInvoice", "Date de r\303\250glement :", 0, QApplication::UnicodeUTF8));
        dateEdit_payment->setDisplayFormat(QApplication::translate("DialogInvoice", "dd/MM/yyyy", 0, QApplication::UnicodeUTF8));
        ...
        label_typePayment->setText(QApplication::translate("DialogInvoice", "R\303\251glement :", 0, QApplication::UnicodeUTF8));
        ...
        toolButton_hide->setToolTip(QApplication::translate("DialogInvoice", "<html><head/><body><p>Affiche ou cache le menu</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        toolButton_hide->setText(QApplication::translate("DialogInvoice", "Hide", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        ...
        groupBox_invoice->setTitle(QString());
#ifndef QT_NO_TOOLTIP
        ...
        label_partpayment->setText(QApplication::translate("DialogInvoice", "Acompte :", 0, QApplication::UnicodeUTF8));
        label_Total->setText(QApplication::translate("DialogInvoice", "Total: 0", 0, QApplication::UnicodeUTF8));
        pushButton_partInvoice->setText(QApplication::translate("DialogInvoice", "Acompte", 0, QApplication::UnicodeUTF8));
        pushButton_creditInvoice->setText(QApplication::translate("DialogInvoice", "Avoir", 0, QApplication::UnicodeUTF8));
        pushButton_createInv->setText(QApplication::translate("DialogInvoice", "Cr\303\251er une facture", 0, QApplication::UnicodeUTF8));
        pushButton_print->setText(QApplication::translate("DialogInvoice", "Imprimer", 0, QApplication::UnicodeUTF8));
        pushButton_ok->setText(QApplication::translate("DialogInvoice", "...", 0, QApplication::UnicodeUTF8));
        pushButton_close->setText(QApplication::translate("DialogInvoice", "Fermer", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
