...
public:
    ...
    void setupUi(QDialog *DialogProduct)
    {
        ...
        label_image = new QLabel(DialogProduct);
        label_image->setObjectName(QString::fromUtf8("label_image"));
        label_image->setPixmap(QPixmap(QString::fromUtf8(":/app/products")));

        horizontalLayout_image->addWidget(label_image);

        horizontalSpacer_3 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalLayout_image->addItem(horizontalSpacer_3);

        verticalLayout_image = new QVBoxLayout();
        verticalLayout_image->setObjectName(QString::fromUtf8("verticalLayout_image"));
        label_txtImg = new QLabel(DialogProduct);
        label_txtImg->setObjectName(QString::fromUtf8("label_txtImg"));

        verticalLayout_image->addWidget(label_txtImg);

        pushButton_image = new QPushButton(DialogProduct);
        pushButton_image->setObjectName(QString::fromUtf8("pushButton_image"));

        verticalLayout_image->addWidget(pushButton_image);

        pushButton_ClearImage = new QPushButton(DialogProduct);
        ...
        verticalLayout_image->addWidget(pushButton_ClearImage);


        horizontalLayout_image->addLayout(verticalLayout_image);


        verticalLayout->addLayout(horizontalLayout_image);
        ...
        toolButton_editCategorie->setIcon(icon2);
        ...
        toolButton_editProvider->setIcon(icon2);
        ...
        toolButton_autoCode->setIcon(icon3);
        ...
        toolButton_editTax->setIcon(icon2);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/app/On"), QSize(), QIcon::Normal, QIcon::Off);
        radioButton_OK->setIcon(icon4);
        ...
        radioButton_Discontinued->setIcon(icon1);
    ...
    void retranslateUi(QDialog *DialogProduct)
    {
        ...
        label_txtImg->setText(QApplication::translate("DialogProduct", "<html><head/><body><p><span style=\" font-family:'Ubuntu'; font-size:9pt; font-weight:600; text-decoration: underline;\">Image produit</span></p><p><span style=\" font-family:'Ubuntu'; font-size:7pt;\">Taille recommand\303\251e :128 X 128px</span></p></body></html>", 0, QApplication::UnicodeUTF8));
        pushButton_image->setText(QApplication::translate("DialogProduct", "Parcourir", 0, QApplication::UnicodeUTF8));
        pushButton_ClearImage->setText(QApplication::translate("DialogProduct", "Effacer l'image", 0, QApplication::UnicodeUTF8));
        ...
        label_titletax->setText(QApplication::translate("DialogProduct", "Tva (%) :", 0, QApplication::UnicodeUTF8));
        ...
        doubleSpinBox_price->setSuffix(QString());
        doubleSpinBox_buyingPrice->setSuffix(QString());
