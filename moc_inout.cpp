...
void inout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData inout::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject inout::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_inout,
      qt_meta_data_inout, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &inout::getStaticMetaObject() { return staticMetaObject; }
