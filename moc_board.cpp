...
static const char qt_meta_stringdata_board[] = {
    "board\0\0on_comboBox_yearsList_currentIndexChanged(QString)\0"
    "item\0"
    "on_tableWidget_InvoiceAlert_itemDoubleClicked(QTableWidgetItem*)\0"
    "on_tableWidget_ProposalAlert_itemDoubleClicked(QTableWidgetItem*)\0"
};
...
void board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_comboBox_yearsList_currentIndexChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->on_tableWidget_InvoiceAlert_itemDoubleClicked((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        case 2: _t->on_tableWidget_ProposalAlert_itemDoubleClicked((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
