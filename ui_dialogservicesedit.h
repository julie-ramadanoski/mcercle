...
public:
    ...
    void setupUi(QDialog *DialogServicesEdit)
    {
        ...
        DialogServicesEdit->resize(836, 503);
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/app/services"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tableWidget_Inter->setMinimumSize(QSize(475, 0));
        ...
        pushButton_close = new QPushButton(groupBox_IntCom);
    ...
    void retranslateUi(QDialog *DialogServicesEdit)
    {
        ...
        label_titletax->setText(QApplication::translate("DialogServicesEdit", "Tva (%):", 0, QApplication::UnicodeUTF8));
        ...
        pushButton_close->setText(QApplication::translate("DialogServicesEdit", "Fermer", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
